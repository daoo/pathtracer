...
#define FINDMINMAX(x0,x1,x2,min,max) \
    ...
    inline int planeBoxOverlap(float normal[3], float vert[3], glm::vec3 maxbox)    // -NJMP-
    {
      int q;
...
#define AXISTEST_Z0(a, b, fa, fb)                          \
  ...
  inline bool triBoxOverlap(const Aabb& aabb, const glm::vec3& triv0, const glm::vec3& triv1, const glm::vec3& triv2) {
    ...
    SUB(v0,triv0,aabb.center);
    SUB(v1,triv1,aabb.center);
    SUB(v2,triv2,aabb.center);
    ...
    if(!detail::planeBoxOverlap(normal,v0,aabb.half)) return false;        // -NJMP-
